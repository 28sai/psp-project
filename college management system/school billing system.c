    ...
    do
{
	...
	i=0;
	//scanf("%s",&pword); 
		if(strcmp(uname,"sansairoh")==0 && strcmp(pword,"sansairoh")==0)
	{
	printf("  \n\n\n       WELCOME TO SR UNIVERSITY  !!!! LOGIN IS SUCCESSFUL");
...
void main(void)
{
    ...
    printf("                    \t**********************************************************\n");
    printf("                    \t*                                                        *\n");
    printf("                    \t***             WELCOME TO SR UNIVERSITY               ***\n");
    printf("                    \t*                  >>College Management System<<         *\n");
    printf("                    \t*                       Address                          *\n");
    printf("                    \t*                  Tel.8790537160                      *\n");
    printf("                    \t*                                                        *\n");
    printf("                    \t**********************************************************\n");
    printf("\n");
    printf("\n");
    ...
    system("color 0");
    printf("\n\n\t || WELCOME TO  SR UNIVERSITY COLLEGE MANAGEMENT SYSTEM  || \n\n\n");
    for(i=0; i<80; i++)
    {
        printf("\xdb");
    }
